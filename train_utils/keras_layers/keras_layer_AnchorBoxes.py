...
from train_utils.bounding_box_utils.bounding_box_utils import convert_coordinates
...
class AnchorBoxes(Layer):
    ...
    def call(self, x, mask=None):
        ...
        # source: https://github.com/pierluigiferrari/ssd_keras/issues/304
        if K.image_data_format() == 'channels_last': # original image_dim_ordering | image_data_format
            batch_size, feature_map_height, feature_map_width, feature_map_channels = x.shape # Original: _keras_shape | shape
        ...
        if (self.this_steps is None):
            step_height = self.img_height // feature_map_height # Original //
    ...
    def compute_output_shape(self, input_shape):
        if K.image_dim_ordering() == 'tf': # image_data_format image_dim_ordering
